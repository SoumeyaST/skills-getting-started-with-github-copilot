              ...
              ${participants
                .map((participant) => `
                  <li class="participant-item">
                    ...
                    ${participant !== "No participants yet" ? `<button class="delete-participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" aria-label="Remove ${participant}">×</button>` : ""}
                  </li>
                `)
                .join("")}
            </ul>
